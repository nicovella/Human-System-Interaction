# Project Repository: Human-System Interaction (HSI) Studies

This repository contains two primary HSI (Human-System Interaction) research projects conducted for the **BSc in Artificial Intelligence** at the **University of Milano-Bicocca** (Academic Year 2025-2026). The research focuses on applying human-centered design principles to both AI conversational agents and mobile transportation interfaces.

---

## Project 1: Evaluation Scale for AI Study-Support Agents

**Goal:** Designing a rigorous framework to assess the interaction quality of LLMs acting as academic mentors.

### Overview

This project utilizes the **Hound Protocol**, assigning AI the role of a "Mentor" rather than a simple tool. The methodology establishes a human baseline through a SWOT analysis, which is then refined via collaborative iteration with various LLMs.
...
## Project 2: Enhancing the Commuter Experience (Trenord App)

**Goal:** An HSI study aimed at transitioning a mobile application from a passive data reporter to a proactive travel assistant.

### Overview

Focused on daily commuters, students, and workers, this study identifies friction points in retrieving real-time information during transit disruptions.
